...
class MicropostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create micropost" do
    assert_difference('Micropost.count') do
      post microposts_url, params: { micropost: { conteudo: @micropost.conteudo, id_usuario: @micropost.id_usuario } }
    end
  ...
  test "should update micropost" do
    patch micropost_url(@micropost), params: { micropost: { conteudo: @micropost.conteudo, id_usuario: @micropost.id_usuario } }
